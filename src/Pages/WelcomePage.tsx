        ...
        <div className="section-page" id="welcome-section">
            <div className="welcome-page">
                ...
                <p className="welcome-text">
                    Es un placer, mi nombre es Diego Alexander Cornejo Menjivar, un desarrollador de software, apasionado de crear soluciones innovadoras y eficientes para los usuarios que necesitan resolver problemas cotidianos, me encantaria tener la oportunidad de ser parte de un grupo de desarrolladores en una empresa ya que, me ayudaria a crecer como desarrollador y adquirir la experiencia que solamente se puede lograr viviendo la experiencia en el mundo real.
                    Actualmente no poseo experiencia laboral en el mundo del software, pero lo que busco es la oportunidad de mostrar mis conocimientos y habilidades, te invito a que evalues mis <a href="#skills">conocimientos y habilidades</a>.
                </p>
            </div>
        </div>
    )
